        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hook",
                    models.CharField(
                        null=True, blank=True, max_length=256, help_text="e.g. module.tasks.result_function"
                    ),
                ),
                ("args", models.CharField(null=True, blank=True, max_length=256, help_text="e.g. 1, 2, 'John'")),
                (
                    "kwargs",
                    models.CharField(null=True, blank=True, max_length=256, help_text="e.g. x=1, y=2, name='John'"),
                ),
                (
                    "schedule_type",
                    models.CharField(
                ...
                (
                    "repeats",
                    models.SmallIntegerField(verbose_name="Repeats", default=-1, help_text="n = n times, -1 = forever"),
                ),
                (
                    "next_run",
                    models.DateTimeField(verbose_name="Next Run", default=django.utils.timezone.now, null=True),
                ),
